...
def call_llm(
    ...
    if state and agent_name:
        ...
        # rg-alpha-engine default: DeepSeek R1 for reasoning. Agents that want
        # the cheap V3 model should set state["metadata"]["model_name"] to
        # "deepseek-chat" or import pick_model() from src.utils.llm_router.
...
def get_agent_model_config(state, agent_name):
    ...
    model_name = state.get("metadata", {}).get("model_name") or "deepseek-reasoner"
